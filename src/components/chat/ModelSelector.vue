  ...
  <div class="relative">
    <button
      ...
      class="flex items-center gap-1.5 px-2.5 py-1 text-xs rounded-md
             bg-app-card text-app-heading hover:bg-[#e8e5db] transition-colors"
    >
    ...
    <div
      v-if="showDropdown"
      class="absolute bottom-full left-0 mb-1 w-52 bg-white border border-app-border rounded-lg shadow-sm py-1 z-50"
    ...
    >
      <button
        ...
        class="w-full text-left px-3 py-2 text-xs hover:bg-[#f3f0eb] transition-colors"
